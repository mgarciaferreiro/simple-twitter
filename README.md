...
* [x] User profile activity with description, number of followers, etc.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/mgarciaferreiro/simple-twitter/blob/master/twitter_walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I implemented modal overlay but it wasn't working as I wanted and I didn't have enough time to fix it so I removed it. It took me a while to debug errors caused by creating users/tweets with fields that the jsonobject didn't have.
